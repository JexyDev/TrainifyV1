    ...
    <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900">{{ $stats['approved_workouts'] }}</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-red-500">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900">{{ $stats['rejected_workouts'] }}</p>
            </div>
...
<div class="bg-gradient-to-r from-blue-600 to-teal-500 rounded-xl shadow-lg p-6 mb-8 text-white">
    ...
    <div class="flex gap-4">
        <a href="{{ route('trainer.workouts.create') }}" class="px-6 py-3 bg-white text-blue-600 rounded-lg hover:bg-gray-100 transition font-semibold">
            + Create New Workout
        </a>
        <a href="{{ route('trainer.workouts.index') }}" class="px-6 py-3 bg-white/20 hover:bg-white/30 rounded-lg transition">
            View All Workouts
        </a>
    </div>
</div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td colspan="5" class="px-6 py-4 text-center text-gray-500">
                        Belum ada workout. <a href="{{ route('trainer.workouts.create') }}" class="text-blue-600 hover:underline">Buat workout pertama Anda</a>
                    </td>
                </tr>
                @endforelse
            </tbody>

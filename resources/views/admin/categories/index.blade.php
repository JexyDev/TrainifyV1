...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.categories.create') }}" class="px-4 py-2 bg-gradient-to-r from-blue-600 to-teal-500 text-white rounded-lg hover:from-blue-700 hover:to-teal-600 transition">
            + Tambah Category
        </a>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 py-1 text-xs rounded-full bg-gray-100 text-gray-700">{{ $category->slug }}</span>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                            ...
                            <form action="{{ route('admin.categories.destroy', $category) }}" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus category ini?')">
                                @csrf
                                @method('DELETE')
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 bg-red-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                            ...
                            <form action="{{ route('admin.categories.force-delete', $category->id) }}" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus PERMANEN?')">
                                @csrf
                                @method('DELETE')

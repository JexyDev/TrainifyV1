    ...
    <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900">{{ $stats['workouts_completed'] }}</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-orange-500">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900">{{ number_format($stats['calories_burned']) }}</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900">{{ number_format($stats['active_minutes']) }}</p>
            </div>
...
<div class="bg-white rounded-xl shadow-md p-6 mb-8">
    ...
    @forelse($recentWorkouts as $progress)
    <div class="flex items-center gap-4 py-3 border-b border-gray-200 last:border-0">
        ...
        <div class="flex-1">
            <h4 class="font-medium text-gray-900">{{ $progress->workout->title }}</h4>
            <div class="flex items-center gap-3 text-sm text-gray-600 mt-1">
                ...
                @if($progress->calories_burned)
                    <span>🔥 {{ $progress->calories_burned }} cal</span>
                @endif
            </div>
        </div>
    </div>
...
<div>
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="{{ route('user.workouts.index') }}" class="text-blue-600 hover:text-blue-800">View All →</a>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="{{ route('user.workouts.show', $workout) }}" class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition block">
            ...
            <div class="p-5">
                <h4 class="font-semibold text-gray-900 mb-2">{{ $workout->title }}</h4>

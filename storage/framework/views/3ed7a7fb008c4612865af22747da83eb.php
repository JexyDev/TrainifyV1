...
<div class="max-w-4xl">
    ...
    <div class="bg-white rounded-xl shadow-md p-6">
        <h2 class="text-2xl font-semibold text-gray-900 mb-6">Edit Workout</h2>

        <?php if($workout->status === 'approved'): ?>
        <div class="mb-4 bg-yellow-50 border border-yellow-200 text-yellow-800 px-4 py-3 rounded-lg">
            ⚠️ Editing an approved workout will reset its status to "Pending" and require admin re-approval.
        </div>
        <?php endif; ?>

        <form action="<?php echo e(route('trainer.workouts.update', $workout)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-4 mb-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="title" 
                        id="title" 
                        value="<?php echo e(old('title', $workout->title)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                        required
                    ><?php echo e(old('description', $workout->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        >
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($category->id); ?>" <?php echo e(old('category_id', $workout->category_id) == $category->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        >
                            <?php $__currentLoopData = $levels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($level->id); ?>" <?php echo e(old('level_id', $workout->level_id) == $level->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            name="duration" 
                            id="duration" 
                            value="<?php echo e(old('duration', $workout->duration)); ?>"
                            min="1"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <div class="mb-2">
                        <img src="<?php echo e(asset('storage/' . $workout->image)); ?>" alt="<?php echo e($workout->title); ?>" class="h-32 rounded-lg">
                    </div>
                    <?php endif; ?>
                    <input 
                        type="file" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <div id="exercises-container" class="space-y-4">
                    <?php $__currentLoopData = $workout->exercises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $exercise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border border-gray-200 rounded-lg p-4 exercise-row" id="exercise-<?php echo e($index + 1); ?>">
                        <div class="flex items-center justify-between mb-3">
                            <h4 class="font-medium text-gray-900">Exercise #<?php echo e($index + 1); ?></h4>
                            <button type="button" onclick="removeExercise(<?php echo e($index + 1); ?>)" class="text-red-600 hover:text-red-800 text-sm">Remove</button>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                            <div class="md:col-span-2">
                                <input 
                                    type="text" 
                                    name="exercises[<?php echo e($index); ?>][name]" 
                                    value="<?php echo e($exercise->name); ?>"
                            ...
                            <div>
                                <input 
                                    type="number" 
                                    name="exercises[<?php echo e($index); ?>][sets]" 
                                    value="<?php echo e($exercise->sets); ?>"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                                    placeholder="Sets"
                                    min="1"
                                    required
                            ...
                            <div>
                                <input 
                                    type="text" 
                                    name="exercises[<?php echo e($index); ?>][reps]" 
                            ...
                            <div class="md:col-span-4">
                                <input 
                                    type="number" 
                                    name="exercises[<?php echo e($index); ?>][rest_seconds]" 
                                    value="<?php echo e($exercise->rest_seconds); ?>"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
...
<script>
let exerciseCount = <?php echo e($workout->exercises->count()); ?>;
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ProjekLaravel\TrainifyV1\resources\views/trainer/workouts/edit.blade.php ENDPATH**/ ?>
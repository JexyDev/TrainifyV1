        ...
        <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-600">
                    Belum punya akun? 
                    <a href="<?php echo e(route('register')); ?>" class="text-blue-600 hover:underline font-semibold">
                        Daftar di sini
                    </a>
                </p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ProjekLaravel\TrainifyV1\resources\views/auth/login.blade.php ENDPATH**/ ?>